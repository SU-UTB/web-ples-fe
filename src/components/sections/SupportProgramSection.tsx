    ...
    <section>
      <InfoCard headline="Doprovodný program">
        <div className="flex flex-col justify-center ">
          <div>
            Abychom vás správně naladili, připravili jsme si po celý únor
            několik doprovodných programů. Těšit se můžete na bruslení na ledové
            ploše, promítání tématického filmu, tančírnu, či workshop na míchání
